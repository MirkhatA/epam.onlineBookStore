        ...
        <c:otherwise>
            ...
            <div class="col-md-7 ms-5 mt-5">
                <form action="/editGenre" method="post">
                    ...
                    <c:if test="${requestScope.editGenreSuccess != null}">
                        <div class="alert alert-success" role="alert">
                            <fmt:message key="success.editGenre"/>
                        </div>
                    </c:if>
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-10">
                            <input name="genreNameEn" type="text" class="form-control" id="genreNameEn" value="${sessionScope.genreParamEn}">
                        </div>
                    </div>
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-10">
                            <input name="genreNameRu" type="text" class="form-control" id="genreNameRu" value="${sessionScope.genreParamRu}">
                        </div>
                    </div>
