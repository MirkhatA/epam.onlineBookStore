...
public class Constants {
    ...
    public static final String REPEAT_PASSWORD = "rePassword";
    ...
    public static final String PAID_STATUS_LIST = "paidStatusList";

    public static final String PLEASE_LOGIN = "pleaseLogin";
    public static final String PASSWORDS_ARE_DIFFERENT = "passwordsAreDifferent";
